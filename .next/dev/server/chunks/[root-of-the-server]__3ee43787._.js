...
"[project]/src/app/api/auth/forgot-password/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!process.env.SMTP_USER || process.env.SMTP_USER === 'your-actual-email@gmail.com' || !process.env.SMTP_PASS) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: 'OTP generated. Check server console or use this code.',
                devOtp: otp
            });
        }
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ee43787._.js.map